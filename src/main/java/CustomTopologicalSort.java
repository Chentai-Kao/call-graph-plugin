/**
 * This is a copy/paste of org.graphstream.algorithm.TopologicalSort from latest gs-algo package.
 * It's not yet available in the stable version (GraphStream 1.x), so copy/paste here for temporary use.
 * See https://github.com/graphstream/gs-algo/blob/master/src/org/graphstream/algorithm/TopologicalSort.java
 */
 ...
 * respectively.
 */
public class CustomTopologicalSort implements Algorithm {
    ...
    public CustomTopologicalSort() {
        this(SortAlgorithm.DEPTH_FIRST);
    }

    public CustomTopologicalSort(SortAlgorithm algorithm) {
